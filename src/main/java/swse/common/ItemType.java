...
public enum ItemType {
    ...
    LANGUAGE, BEAST_ATTACK("beastAttack"), SPECIES_TYPE("beastType"), AFFILIATION("affiliation"), FORCE_POWER("forcePower"), FORCE_SECRET("forceSecret"), FORCE_TECHNIQUE("forceTechnique");
