...
public class BeastComponentExporter extends BaseExporter
{
    ...
    private static Collection<? extends JSONObject> getManualItems() {
        ...
        items.add(BeastComponent.create("Bite").withSubtype("Melee Natural Weapons")
                ...
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Poison"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d6"))
                .toJSON());
        ...
        items.add(BeastComponent.create("Claw").withSubtype("Melee Natural Weapons")
                ...
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Poison"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d4"))
                .toJSON());

        items.add(BeastComponent.create("Tentacle").withSubtype("Melee Natural Weapons")
        ...
        items.add(BeastComponent.create("Tendril").withSubtype("Melee Natural Weapons")
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Bludgeoning"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d6"))
                .toJSON());
        ...
        items.add(BeastComponent.create("Pincer").withSubtype("Melee Natural Weapons")
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Piercing"))
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Poison"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d4"))
                .toJSON());

        items.add(BeastComponent.create("Tail").withSubtype("Melee Natural Weapons")
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Bludgeoning"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d4"))
                .toJSON());
        ...
        items.add(BeastComponent.create("Tail Slap").withSubtype("Melee Natural Weapons")
                .with(Change.create(ChangeKey.DAMAGE_TYPE, "Bludgeoning"))
                .with(Change.create(ChangeKey.REACH, "+1"))
                .with(Change.create(ChangeKey.DAMAGE.scalable(), "1d4"))
                .toJSON());
